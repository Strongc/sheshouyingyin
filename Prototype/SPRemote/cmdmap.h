...
inline void GetRemoteCmdMap(REMOTECMD& remotecmd)
{
  ...
  // basic function
  ADD_REMOTECMD("887"/*play*/, tagRemoteCmdInfo(ID_PLAY_PLAY, ID_PLAY_PLAY, 0));
  ADD_REMOTECMD("888"/*pause*/, tagRemoteCmdInfo(ID_PLAY_PAUSE, ID_PLAY_PAUSE, 0));
  ADD_REMOTECMD("stop", tagRemoteCmdInfo(ID_FILE_CLOSEPLAYLIST, ID_FILE_CLOSEPLAYLIST, 0));
  ADD_REMOTECMD("920"/*prev*/, tagRemoteCmdInfo(ID_NAVIGATE_SKIPBACKPLITEM, ID_NAVIGATE_SKIPBACKPLITEM, 0));
  ADD_REMOTECMD("921"/*next*/, tagRemoteCmdInfo(ID_NAVIGATE_SKIPFORWARDPLITEM, ID_NAVIGATE_SKIPFORWARDPLITEM, 0));
